              ...
              <table class="table table-striped jambo_table bulk_action">
                ...
                <?php foreach($arr as $rows): ?>
                  <tr class="even pointer">
                    ...
                    <td class=" last">
                      <a href="truongbomon.php?controller=detaidangthuchien&<?php echo "act=hoanthanh&id=".$rows->pk_madetai_id ?>">
                          <button  type="button" class="btn btn-default btn-xs btn-duyet">Hoàn thành</button>
                      </a>
                      <a href="truongbomon.php?controller=detaidangthuchien&<?php echo "act=huy&id=".$rows->pk_madetai_id ?>">
