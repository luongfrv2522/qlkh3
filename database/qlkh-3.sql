...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 21, 2018 lúc 07:46 PM
...
INSERT INTO `tbl_bomon` (`pk_mabomon_id`, `c_tenbomon`, `c_truongbomon`) VALUES
(57, 'Ngôn ngữ Anh', 'Nguyễn Văn A');
...
INSERT INTO `tbl_detai` (`pk_madetai_id`, `c_tendetai`, `c_noidungnghiencuu`, `c_kinhphi`, `c_tungay`, `c_denngay`, `c_trangthai`) VALUES
(2, 'Nghiên cứu toán học', 'Giải tích', 10000000, '2018-10-01', '2018-10-25', 0),
(3, 'Nghiên cứu công nghệ điện tử', 'Kĩ thuật điện tử', 10000000, '2018-10-08', '2018-10-25', 1);
...
(46, 0, 56, 'Nguyễn Minh Hòa', '1988-02-01', 'Tiến sĩ', 'no1', 'Hà nội', 985698736, 'admin2@mail.com'),
...
--
-- Cấu trúc bảng cho bảng `tbl_thanhvienhoidong`
--
...
(3, 'admin2@mail.com', '25f9e794323b453885f5181f1b624d0b', 'Nguyễn Văn C'),
...
(6, 'admin12@mail.com', '202cb962ac59075b964b07152d234b70', 'Nguyễn Văn F'),
(7, 'admin123@mail.com', '202cb962ac59075b964b07152d234b70', 'Nguyễn Văn G'),
(8, 'admin@mail.com', '202cb962ac59075b964b07152d234b70', 'Nguyễn Văn A'),
(9, 'tam@mail.com', '202cb962ac59075b964b07152d234b70', 'Ngô Thanh Tâm');
...
--
-- Cấu trúc bảng cho bảng `tbl_vaitrohoidong`
--
...
--
-- Chỉ mục cho bảng `tbl_thanhvienhoidong`
--
...
--
-- Chỉ mục cho bảng `tbl_vaitrohoidong`
--
...
--
ALTER TABLE `tbl_giaovien`
  MODIFY `pk_magiaovien_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
-- AUTO_INCREMENT cho bảng `tbl_thanhvienhoidong`
--
ALTER TABLE `tbl_thanhvienhoidong`
...
--
-- AUTO_INCREMENT cho bảng `tbl_vaitrohoidong`
--
ALTER TABLE `tbl_vaitrohoidong`
