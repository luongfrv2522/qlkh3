...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 22, 2018 at 07:35 PM
...
(56, 'Bộ môn 1', 'Trưởng bộ môn 1', 11),
(57, 'Ngôn ngữ Anh', 'Nguyễn Văn A', 0);
...
(2, 10, 0, 'Nghiên cứu toán học', 'Giải tích', 10000000, '2018-10-01', '2018-10-25', 0, ''),
(3, 10, 0, 'Nghiên cứu công nghệ điện tử', 'Kĩ thuật điện tử', 10000000, '2018-10-08', '2018-10-25', 1, '');
...
(46, 10, 56, 'Nguyễn Minh Hòa', '1988-02-01', 'Tiến sĩ', 'no1', 'Hà nội', 985698736, 'admin2@mail.com'),
(47, 0, 56, 'Nguyễn Minh Hòa', '1988-02-01', 'Tiến sĩ', 'no1', 'Hà nội', 985698736, 'admin2@mail.com'),
(52, 0, 57, 'test', '0000-00-00', 'không', 'không', 'không', 972205996, 'ksjdhksa@gmail.com');
...
CREATE TABLE `tbl_hoidong` (
  ...
  `c_hoidong` varchar(500) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `tbl_lichbaove`
--
...
--
-- Table structure for table `tbl_nam`
--

CREATE TABLE `tbl_nam` (
  `pk_nam_id` int(11) NOT NULL,
  `c_nam` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `tbl_thanhvienhoidong`
--

CREATE TABLE `tbl_thanhvienhoidong` (
  `pk_thanhvienhoidong_id` int(11) NOT NULL,
  `fk_nam_id` int(11) NOT NULL,
  `fk_vaitrohoidong_id` int(11) NOT NULL,
  `fk_hoidong_id` int(11) NOT NULL,
  `c_thanhvienhoidong` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tbl_user` (`pk_user_id`, `c_email`, `c_password`, `c_fullname`, `UserType`) VALUES
(3, 'admin2@mail.com', '25f9e794323b453885f5181f1b624d0b', 'Nguyễn Văn C', 0),
(4, 'admin3@mail.com', '202cb962ac59075b964b07152d234b70', 'Nguyễn Văn D', 0),
(5, 'admin4@mail.com', '202cb962ac59075b964b07152d234b70', 'Nguyễn Văn E', 0),
(6, 'admin12@mail.com', '202cb962ac59075b964b07152d234b70', 'Nguyễn Văn F', 0),
(7, 'admin123@mail.com', '202cb962ac59075b964b07152d234b70', 'Nguyễn Văn G', 0),
(8, 'admin@mail.com', '202cb962ac59075b964b07152d234b70', 'Nguyễn Văn A', 0),
(9, 'tam@mail.com', '202cb962ac59075b964b07152d234b70', 'Ngô Thanh Tâm', 0),
(10, 'giaovien1@gmail.com', '202cb962ac59075b964b07152d234b70', 'giaovien1', 1),
(11, 'truongbomon1@gmail.com', '202cb962ac59075b964b07152d234b70', 'truongbomon1', 2),
(12, 'hoidong1@gmail.com', '202cb962ac59075b964b07152d234b70', 'hoidong1', 3);
...
--
-- Table structure for table `tbl_vaitrohoidong`
--

CREATE TABLE `tbl_vaitrohoidong` (
  `pk_vaitrohoidong_id` int(11) NOT NULL,
  `c_vaitrohoidong` varchar(500) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Indexes for table `tbl_thanhvienhoidong`
--
ALTER TABLE `tbl_thanhvienhoidong`
  ADD PRIMARY KEY (`pk_thanhvienhoidong_id`);
...
--
-- Indexes for table `tbl_vaitrohoidong`
--
ALTER TABLE `tbl_vaitrohoidong`
  ADD PRIMARY KEY (`pk_vaitrohoidong_id`);
...
--
-- AUTO_INCREMENT for table `tbl_bomon`
--
ALTER TABLE `tbl_bomon`
  MODIFY `pk_mabomon_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
...
--
ALTER TABLE `tbl_detai`
  MODIFY `pk_madetai_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tbl_giaovien`
--
ALTER TABLE `tbl_giaovien`
  MODIFY `pk_magiaovien_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;

--
-- AUTO_INCREMENT for table `tbl_hoidong`
--
ALTER TABLE `tbl_hoidong`
  MODIFY `pk_hoidong_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_lichbaove`
--
ALTER TABLE `tbl_lichbaove`
  MODIFY `pk_malichbaove_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_nam`
--
ALTER TABLE `tbl_nam`
  MODIFY `pk_nam_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `tbl_thanhvienhoidong`
--
ALTER TABLE `tbl_thanhvienhoidong`
  MODIFY `pk_thanhvienhoidong_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tbl_vaitro`
  MODIFY `pk_vaitro_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_vaitrohoidong`
--
ALTER TABLE `tbl_vaitrohoidong`
  MODIFY `pk_vaitrohoidong_id` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
