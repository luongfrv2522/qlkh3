<?php 
	class controller_thongtinhoidongnghiemthu{
		...
		public function __construct(){
			...
			$arr = $this->model->get_all("select * from tbl_hoidong_detai where fk_hoidong_id = $fk_hoidongnghiemthu_id order by fk_hoidongnghiemthu_id desc limit $from,$record_per_page");
			//load view
